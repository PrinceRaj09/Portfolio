    ...
    <section className='services section' id='services'>
        ...
        <div className="services__container container grid">
            <div className="services__content">
                ...
                <span className="services__button" onClick={() => toggleTab(1)}>View More <i className="uil uil-arrow-right services button-icon"></i></span>
                ...
                <div className={toggleState === 1 ? "services__modal active-model" : "services__modal"}>
                    <div className="services__modal-content">
                        ...
                        <p className="services__modal-description">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut quis, distinctio Lorem ipsum dolor sit Lorem, ipsum dolor.
                        </p>
            ...
            <div className="services__content">
                ...
                onClick={() => toggleTab(2)}
                >View More <i className="uil uil-arrow-right services button-icon"></i></span>
