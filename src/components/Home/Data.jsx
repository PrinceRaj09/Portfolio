...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className='home__title hand'>Prince Raj <svg
                  width="38"
                  height="38"
                  viewBox="0 0 48 48"
                  fill="none"
        ...
        <p>A passionate frontend developer with specialized in creating responsive and dynamic web applications</p>

        <NavLink to="/contact" className='button button--flex'>Say Hello
        <svg
